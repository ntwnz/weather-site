document.querySelector('#search').addEventListener('submit', async (event) => {
    ...
    if(!cityName){
        ...
        return showAlert(`Você deve digitar uma cidade`);
    }
    const apiKey = '82005d27a116c2880c8f0fcb866998a0';
    const apiUrl = `https://api.openweathermap.org/data/2.5/weather?q=${encodeURI(cityName)}&lang=pt_br&appid=${apiKey}&units=metric`;
